...
1.  Download `NavSystem_Firmware_v1.bin`.
...
## 🤝 System Architecture
This project is part of a dual-component system. To function correctly, it must be paired with the **NavigationSystemMobileCompanion** Android application.
